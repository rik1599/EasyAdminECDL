 ...
 */
final class Version20200918131503 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE certification (id INT AUTO_INCREMENT NOT NULL, update_certification_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, duration VARCHAR(255) DEFAULT NULL COMMENT \'(DC2Type:dateinterval)\', UNIQUE INDEX UNIQ_6C3C6D756B9278B (update_certification_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE skill_card (id INT AUTO_INCREMENT NOT NULL, student_id INT NOT NULL, certification_id INT NOT NULL, number VARCHAR(7) NOT NULL, credits INT NOT NULL, expires_at DATETIME DEFAULT NULL, status VARCHAR(32) NOT NULL, INDEX IDX_51550461CB944F1A (student_id), INDEX IDX_51550461CB47068A (certification_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE booking (id INT AUTO_INCREMENT NOT NULL, skill_card_id INT NOT NULL, session_id INT NOT NULL, module_id INT NOT NULL, datetime DATETIME NOT NULL, INDEX IDX_E00CEDDE50390409 (skill_card_id), INDEX IDX_E00CEDDE613FECDF (session_id), INDEX IDX_E00CEDDEAFC2B591 (module_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE booking ADD CONSTRAINT FK_E00CEDDEAFC2B591 FOREIGN KEY (module_id) REFERENCES module (id)');
    }
