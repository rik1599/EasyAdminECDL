 ...
 */
final class Version20200916152333 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE skill_card_module ADD CONSTRAINT FK_C005EC90AFC2B591 FOREIGN KEY (module_id) REFERENCES module (id)');
    }
